...
public class UserInfo extends BaseModel<UserInfo> {
	...
	public UserInfo myFindById(String ids){
		String sql = getSql("platform.userInfo.myFindById");
		UserInfo userInfo = UserInfo.dao.findFirst(sql, ids);
		return userInfo;
	}
	
	public UserInfo userinfoFindById(String ids){
		String sql = getSql("platform.userInfo.userinfoFindById");
		UserInfo userInfo = UserInfo.dao.findFirst(sql, ids);
		return userInfo;
	}
