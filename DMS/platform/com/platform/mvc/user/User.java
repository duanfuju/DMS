...
public class User extends BaseModelCache<User> {
	...
	private String yangHuLuDuanId;
	
	
	public String getYangHuLuDuanId() {
		return yangHuLuDuanId;
	}
	public void setYangHuLuDuanId(String yangHuLuDuanId) {
		this.yangHuLuDuanId = yangHuLuDuanId;
	}
	...
	public UserInfo getUserInfo(){
		...
		if(null != userinfoIds && !userinfoIds.isEmpty()){
			return UserInfo.dao.myFindById(userinfoIds);
		}
		return null;
	}
