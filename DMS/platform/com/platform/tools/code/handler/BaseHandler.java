...
public abstract class BaseHandler {
	 ...
	 * @param colunmList		model字段信息
	 */
	public void add(String classNameSmall,String basePath){
		Map<String, Object> paraMap = new HashMap<String, Object>();
		paraMap.put("classNameSmall", classNameSmall);
		paraMap.put("basePath", basePath);
		paraMap.put("cxt", "${cxt!}");
		paraMap.put("include", "<% include('/"+basePath+"/"+classNameSmall+"/form.html'){} %>");
//		paraMap.put("include", "sss");
	 ...
	 * @param colunmList		model字段信息
	 */
	public void update(String classNameSmall,String basePath,String pkName){
		Map<String, Object> paraMap = new HashMap<String, Object>();
		paraMap.put("classNameSmall", classNameSmall);
		paraMap.put("basePath", basePath);
		paraMap.put("pkName", pkName);
