...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
  ...
  <LastSaved>2016-09-13T06:30:07Z</LastSaved>
 ...
 <Worksheet ss:Name="Sheet1">
  <Table ss:ExpandedColumnCount="29" ss:ExpandedRowCount="${ExcelRowSize!}" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="21.75">
    ...
    <Cell><Data ss:Type="String">维修开始时间</Data></Cell>
    <Cell><Data ss:Type="String">维修结束时间</Data></Cell>
    <Cell><Data ss:Type="String">整体线形</Data></Cell>
    <Cell><Data ss:Type="String">维修长度</Data></Cell>
    <Cell><Data ss:Type="String">具体位置</Data></Cell>
    <Cell><Data ss:Type="String">损坏原因类型</Data></Cell>
    <Cell><Data ss:Type="String">损坏原因</Data></Cell>
    <Cell><Data ss:Type="String">事故时间</Data></Cell>
    <Cell><Data ss:Type="String">未及时修补原因</Data></Cell>
    <Cell><Data ss:Type="String">损坏现状描述</Data></Cell>
    <Cell><Data ss:Type="String">其他相关项目维修数量</Data></Cell>
    <Cell><Data ss:Type="String">病害类型</Data></Cell>
   </Row>
   <#list List as jl>
   <Row ss:Height="14.25">
    ...
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.weiXiuStartTime!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.weiXiuEndTime!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.ztXianXing!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.weiXiuChangDu!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.juTiWeiZhi!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.sunHuaiCauseType!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.sunHuaiCause!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.shiGuTime!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.wjsxbCause!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.sunHuaiMiaoShu!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.qiTaWeiXiuNum!}</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">${jl.luBingType!}</Data></Cell>
   </Row>
   </#list>
  </Table>
