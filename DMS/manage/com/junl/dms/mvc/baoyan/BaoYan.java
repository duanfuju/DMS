...
public class BaoYan extends BaseModel<BaoYan> {
	
	private static final long serialVersionUID = 5979434062234466436L;

	private static Logger log = Logger.getLogger(BaoYan.class);
	
	public static final BaoYan dao = new BaoYan();
	...
	//获取本月的任务数
		public List<BaoYan> getTaskNo(){
			String sql = getSql("manage.baoyan.getTaskNo");
			List<BaoYan> list = BaoYan.dao.find(sql);
			return list;
		}
